...
public class FindaLooSearch {
	public AppiumDriver driver;

	public FindaLooSearch(AppiumDriver driver) {
		this.driver = driver;
	...
	public WebElement getSearchAutoComplete() {
	    return searchAutoComplete;
	}

	@AndroidFindBy(uiAutomator = "new UiSelector().resourceId(\"android:id/date_picker_header_date\")")
